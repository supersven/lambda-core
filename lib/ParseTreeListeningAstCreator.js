...
var LambdaCalculusLexer = require("../generated/LambdaCalculusLexer");
var LambdaCalculusParser = require("../generated/LambdaCalculusParser");
var LambdaCalculusListener = require("../generated/LambdaCalculusListener").LambdaCalculusListener;
var LambdaCalculusVisitor = require("../generated/LambdaCalculusVisitor").LambdaCalculusVisitor;
...
AstCreator.prototype.visitInteger = function (ctx) {
    return parser.IntegerLiteral(ctx.getText());
};

AstCreator.prototype.visitVariable = function (ctx) {
    return parser.Variable(ctx.getText());
};

AstCreator.prototype.visitLambda = function (ctx) {
    return parser.LambdaDefinition(ctx.children[1].accept(this), ctx.children[3].accept(this));
};
...
AstCreator.prototype.visitApplication = function (ctx) {
    return parser.Application(ctx.children[1].accept(this), ctx.children[3].accept(this))
};
