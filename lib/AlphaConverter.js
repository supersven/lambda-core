...
module.exports.alphaConverter = function AlphaConverter() {
    ...
    function createVariableWithID(name, symbolMap) {
        ...
        return new AstNodeFactory.VariableWithId(name, id);
    }
    ...
    function convertInternal(ast, symbolMap) {
        if (Helpers.isLambda(ast)) {
            ...
            var newParameter = createVariableWithID(firstParameter, updatedSymbolMap);
            ...
            var lambdaDefinition = new AstNodeFactory.LambdaDefinition(newParameter, newExpression);
